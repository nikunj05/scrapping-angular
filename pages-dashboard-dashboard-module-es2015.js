...
/* harmony import */ var _dashboard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../dashboard.service */ "./src/app/pages/dashboard/dashboard.service.ts");
...
let AddsiteComponent = class AddsiteComponent {
    ...
    addSite() {
        ...
        if (this.siteForm.invalid) {
            ...
            this.service.addsite(addObj).subscribe((response) => {
...
AddsiteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-addsite',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./addsite.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/dashboard/addsite/addsite.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./addsite.component.css */ "./src/app/pages/dashboard/addsite/addsite.component.css")).default]
    }),
...
/* harmony import */ var _addsite_addsite_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addsite/addsite.component */ "./src/app/pages/dashboard/addsite/addsite.component.ts");
/* harmony import */ var _editsite_editsite_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editsite/editsite.component */ "./src/app/pages/dashboard/editsite/editsite.component.ts");
/* harmony import */ var _deletesite_deletesite_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./deletesite/deletesite.component */ "./src/app/pages/dashboard/deletesite/deletesite.component.ts");
/* harmony import */ var _viewsite_viewsite_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./viewsite/viewsite.component */ "./src/app/pages/dashboard/viewsite/viewsite.component.ts");
...
let DashboardComponent = class DashboardComponent {
    ...
    deletesite(id) {
        const modalRef = this.modalService.open(_deletesite_deletesite_component__WEBPACK_IMPORTED_MODULE_6__["DeletesiteComponent"], { size: 'lg', windowClass: 'big_popup' });
        modalRef.componentInstance.siteid = id;
        // swal({
        //   title: 'Are you sure?',
    ...
    editsite(data) {
        const modalRef = this.modalService.open(_editsite_editsite_component__WEBPACK_IMPORTED_MODULE_5__["EditsiteComponent"], { size: 'lg', windowClass: 'big_popup' });
    ...
    addsite() {
        const modalRef = this.modalService.open(_addsite_addsite_component__WEBPACK_IMPORTED_MODULE_4__["AddsiteComponent"], { size: 'lg', windowClass: 'big_popup' });
    }
    siteDetails(data) {
        const modalRef = this.modalService.open(_viewsite_viewsite_component__WEBPACK_IMPORTED_MODULE_7__["ViewsiteComponent"], { size: 'lg', windowClass: 'big_popup' });
        modalRef.componentInstance.siteid = data._id;
        modalRef.componentInstance.baseurl = data.baseurl;
        modalRef.componentInstance.hospital_map = data.hospital_map;
        modalRef.componentInstance.img_map = data.img_map;
...
DashboardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_dashboard_service__WEBPACK_IMPORTED_MODULE_2__["DashboardService"],
...
/* harmony import */ var _deletesite_deletesite_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./deletesite/deletesite.component */ "./src/app/pages/dashboard/deletesite/deletesite.component.ts");
/* harmony import */ var _editsite_editsite_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editsite/editsite.component */ "./src/app/pages/dashboard/editsite/editsite.component.ts");
/* harmony import */ var _addsite_addsite_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./addsite/addsite.component */ "./src/app/pages/dashboard/addsite/addsite.component.ts");
/* harmony import */ var _viewsite_viewsite_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./viewsite/viewsite.component */ "./src/app/pages/dashboard/viewsite/viewsite.component.ts");
...
let DashboardService = class DashboardService {
    ...
    getlist() {
        return this.http.get(URL + '/sitelist')
            .pipe((res) => {
            return res;
        });
    }
    addsite(data) {
        return this.http.post(URL + '/addsite', data, { headers: this.getHeader() })
            .pipe((res) => {
            return res;
        });
    }
    deletesite(siteid) {
        return this.http.delete(URL + '/deletesite?id=' + siteid, { headers: this.getHeader() })
            .pipe((res) => {
            return res;
        });
    }
    updatesite(siteid, data) {
        return this.http.put(URL + '/updatesite?id=' + siteid, data, { headers: this.getHeader() })
            .pipe((res) => {
            return res;
        });
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeletesiteComponent", function() { return DeletesiteComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
// import { ToastrManager } from 'ng6-toastr-notifications';
let DeletesiteComponent = class DeletesiteComponent {
    ...
    delete() {
        this.service.deletesite(this.siteid).subscribe((response) => {
            if (response.statusCode == 200) {
                window.location.reload();
                //  this.toastService.successToastr(response.msg);
            }
            else {
                // this.toastService.errorToastr(response.msg);
            }
            this.activeModal.dismiss();
        });
    }
...
DeletesiteComponent.ctorParameters = () => [
...
DeletesiteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-deletesite',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./deletesite.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/dashboard/deletesite/deletesite.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./deletesite.component.css */ "./src/app/pages/dashboard/deletesite/deletesite.component.css")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbActiveModal"],
        _dashboard_service__WEBPACK_IMPORTED_MODULE_1__["DashboardService"]])
], DeletesiteComponent);
...
// import { ShipManagementServivce } from '../shipmanagement.service'

// import { ToastrManager } from 'ng6-toastr-notifications';


let EditsiteComponent = class EditsiteComponent {
    constructor(
    // private toastService: ToastrManager, 
    ...
    editSite() {
        ...
        if (this.siteForm.invalid) {
            ...
            console.log("object add ship =======>", addObj);
            this.activeModal.dismiss();
            this.service.updatesite(this.siteid, addObj).subscribe((response) => {
...
EditsiteComponent.ctorParameters = () => [
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "baseurl", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "hospital_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "img_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "src_link", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "stucture_type", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "title_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "url", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], EditsiteComponent.prototype, "url_prefix", void 0);
EditsiteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-editsite',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./editsite.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/dashboard/editsite/editsite.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./editsite.component.css */ "./src/app/pages/dashboard/editsite/editsite.component.css")).default]
    }),
...
let ViewsiteComponent = class ViewsiteComponent {
...
ViewsiteComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
];
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "siteid", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "baseurl", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "hospital_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "img_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "src_link", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "stucture_type", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "title_map", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "url", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
], ViewsiteComponent.prototype, "url_prefix", void 0);
ViewsiteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-viewsite',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./viewsite.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/dashboard/viewsite/viewsite.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./viewsite.component.css */ "./src/app/pages/dashboard/viewsite/viewsite.component.css")).default]
    }),
